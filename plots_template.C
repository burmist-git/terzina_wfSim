...
Int_t plots_template(){
  ...
  fileN02 = "./wfData/linearExpExp_NUVHD_25um_conv_fit_20MHz_filter.txt";
  fileN03 = "./wfData/linearExpExp_NUVHD_25um_conv_fit_40MHz_filter.txt";
  //
  //fileN01 = "./wfData/linearExpExp_NUVHD_35um_conv.txt";
  //fileN02 = "./wfData/linearExpExp_NUVHD_35um_conv_fit_20MHz_filter.txt";
  //fileN03 = "./wfData/linearExpExp_NUVHD_35um_conv_fit_40MHz_filter.txt";
  //
  ...
  gr02->SetName("gr02");
  //
  TGraph *gr03 = new TGraph();
  gr02->SetTitle("gr03");
  gr02->SetName("gr03");
  //
  load_data(fileN01, gr01);
  load_data(fileN02, gr02);
  load_data(fileN03, gr03);
  //
  ...
  gr02->SetLineWidth(2);
  //
  gr03->SetMarkerStyle(1);
  gr03->SetMarkerColor(kBlue);
  gr03->SetLineColor(kBlue);
  gr03->SetLineWidth(2);
  //
  ...
  leg01->AddEntry(gr01, "b/w : Full", "pl");
  leg01->AddEntry(gr02, "b/w : 20 MHz", "pl");
  leg01->AddEntry(gr03, "b/w : 40 MHz", "pl");
  leg01->Draw();
  ///////////////////////
  ...
  leg02->AddEntry(gr01, "b/w : Full", "pl");
  leg02->AddEntry(gr02, "b/w : 20 MHz", "pl");
  leg02->AddEntry(gr03, "b/w : 40 MHz", "pl");
  leg02->Draw();
  ///////////////////////
  return 0;
}
